...
# fixed pixel values of logarithms appropriate to finding the log of an 8-bit
 ...
 * 255, so it's the base 2 logarithm of a normalized 8-bit floating pixel
...
# The exponent table.
cat <<END
/* The 'exp()' case must invert the above, taking a 20-bit fixed pixel
